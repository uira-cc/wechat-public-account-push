...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxc4cb05ef67e473c9',

  // 使用微信测试号时才需要填写：公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'f811e31c098592b138022d12247dc62a',
  ...
  USERS: [
    {
      ...
      useTemplateId: 'S_RfA_ljnZuuUJhzFUyM4nFbBB4ztp03uhrel3sHbw0',
      // 所在省份或城市，也可以不填
      province: '',
      // 所在城市或县区
      city: '',
      ...
      festivals: [
        ...
        {
          type: '生日', name: '老婆', year: '1994', date: '02-25',
        },
        {
          type: '节日', name: '结婚纪念日', year: '2023', date: '12-23',
        },
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {
          type: '生日', name: '李四', year: '1994', date: '01-16',
        }
      ],
      ...
      customizedDateList: [
        ...
        { keyword: 'marry_day', date: '2023-12-23' },
         // 结婚纪念日
        { keyword: 'love_day', date: '2024-09-22' }
      ],
    },
     {
      // 想要发送的人的名字
  ...
  CALLBACK_TEMPLATE_ID: 'WOLMpNdllV0rw0bczUAHswGR5uen4Qeny35t1Kh8pWA',
